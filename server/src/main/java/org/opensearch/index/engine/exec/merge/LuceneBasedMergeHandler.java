...
public class LuceneBasedMergeHandler extends MergeHandler {

    IndexWriter writer;
    MergePolicy mergePolicy;
    Map<List<FileMetadata>, MergePolicy.OneMerge> listFileMetadataToOneMerge = new HashMap<>();

    public LuceneBasedMergeHandler(CompositeEngine compositeEngine, CompositeIndexingExecutionEngine compositeIndexingExecutionEngine, Any dataFormats, IndexWriter indexWriter) {
    ...
    public List<Merge> findMerges() throws IOException {
        System.out.println("In LuceneBasedMergeHandler ================== ");
        ...
        System.out.println("Returned merges ======== " + merges);
        return merges;
    }
